                                         ...
                                         INotificationSubscriber<InnerPlayListChangedNotification>
{
    ...
    private readonly IPlayCoreWrapper _playCoreWrapper;
    private readonly INotificationHub _notificationHub;
    private PlayListManagerBase? _playListManager;
    private List<SingleSongBase> _list = new();

    public OrderedRollPlayController(IPlayCoreWrapper playCoreWrapper, PlayListManagerBase? playListManager, INotificationHub notificationHub)
    {
        _playCoreWrapper = playCoreWrapper;
